...
public:
    ...
    // Resolves the single running sequence for an Eagle3 request. The scheduler reserves
    // the requested linear-attention checkpoints atomically during the following step.
